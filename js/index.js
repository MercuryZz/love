...
function timeElapse() {
  ...
  var time = "<span>" + day + " days " + hour + " hours " + min + " minutes " + sec + " seconds " + "</span>"
  var timer = document.getElementById("timer");
  timer.innerHTML = time;
}

var bodybody = document.getElementById("body")
...
var S = {
  init: function () {
    ...
    S.UI.simulate('Shapa|I ❤ U|🌙☀️⭐');

    setTimeout(() => {
      document.getElementById('canvas').style.transform = "scale(0) translateX(-50%)";
      document.getElementById('timer').style.transform = "scale(1) translateX(-50%)";
...
S.Drawing = (function () {
  ...
  return {
    ...
    adjustCanvas: function () {
      canvas.width = bodybody.offsetWidth * 0.6
      canvas.height = bodybody.offsetHeight * 0.6;
    },
...
S.ShapeBuilder = (function () {
  ...
  function fit() {
    shapeCanvas.width = Math.floor(bodybody.offsetWidth * 0.6 / gap) * gap;
    shapeCanvas.height = Math.floor(bodybody.offsetHeight * 0.6 / gap) * gap;
